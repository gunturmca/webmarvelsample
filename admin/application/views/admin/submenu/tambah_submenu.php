...
<script type="text/javascript">
 ...
 <div class=" row"  style="margin-top:-18px">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Tambah menuitem</h2>
 ...
 <div id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
                <!-- form start -->
                 ...
                 <form id="form2" name="form2" method="" action=""  >
                      ...
                      <a href="<?php echo base_url(); ?>csubmenu/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back</a>
