...
<script type="text/javascript">
						 ...
						 showfield();
						   ...
						   $('#simpan').on('click', function(){
							...
							$('#add').on('click', function(){
								window.location = '<?php echo base_url(); ?>cjabatan/tambah_jabatan';
							});
						  });
 ...
 <div id="content" class="">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Edit Jabatan</h2>
 ...
 <div  id="groupinput" class="form-group" style="overflow:auto; margin:0 0 10px 0;"> 
              ...
              <form id="form2" name="form2" method="" action=""  >
                  ...
                  <a href="<?php echo base_url(); ?>cjabatan/tampil" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
